                ...
                <Card style={{ border: 'none' }} className='mb-3' onMouseOver={mouseOver} onMouseOut={mouseOut} >
                    ...
                    <Card.Body>
                        <Card.Title className='mb-3' style={{fontSize: '1rem'}} >
                            ...
                            <Button type='submit' className='m-auto align-self-center d-flex' variant='danger' onClick={() => props.cartRemove(props.product) | props.onReduceCountCart(props.product) }>
